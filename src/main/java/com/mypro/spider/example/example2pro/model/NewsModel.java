...
public class NewsModel implements Serializable , ParseModel{
  ...
  private List<ReviewModel> reviews; // 回复
  ...
  private String backLink; // 标记是否有引用其他网站的文章，有则将原链接放在此栏为
