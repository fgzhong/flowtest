...
//    private final static Random RANDOM = new Random();
    private final static String[] PC_AGENT_ARRAY = new String[]{
    ...
    private final static String[] PHONE_UGENT_ARRAY = new String[]{
    ...
    private static int PC_AGENT_LEN = PC_AGENT_ARRAY.length;
    private static int PHONE_AGENT_LEN = PHONE_UGENT_ARRAY.length;


//    public static String getPCAgent() {
//        return PC_AGENT_ARRAY[RANDOM.nextInt(PC_AGENT_LEN)];
//    }
    public static String getPCAgent() {
        return PC_AGENT_ARRAY[ThreadLocalRandom.current().nextInt(PC_AGENT_LEN)];
    }

    public static String getPhoneAgent() {
        return PHONE_UGENT_ARRAY[ThreadLocalRandom.current().nextInt(PHONE_AGENT_LEN)];
    }
