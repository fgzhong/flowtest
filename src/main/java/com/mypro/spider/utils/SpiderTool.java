...
import com.mypro.spider.data.Spider;
...
public abstract class SpiderTool extends Configured {

  protected HashMap<String, Object> results = Maps.newHashMap();
  ...
  public SpiderTool(Configuration conf){
    super(conf);
    getConf().addResource("spider.xml");
  }
  ...
  public float getProgress() {
    ...
    status.put(Spider.STAT_PROGRESS, res);
    return res;
  }
  ...
  public static Configuration creatConfiguration() {
